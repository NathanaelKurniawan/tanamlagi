...
<div class="hero-background">
    ...
    <div class="hero-content">
        ...
        <a class="btn btn-hero mt-3" href="/pilihan">Cari Aktivitas</a>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="hero-section text-center" style="background-color: #6B8E23; color: white; border-radius: 12px; padding: 20px;">
                ...
                <a class="btn card-btn mt-3" href="/pilihan">Cari Aktivitas</a>
            </div>
        </div>
...
<div class="activity-section">
            ...
            <div class="col-md-3">
                <div class="card activity-card">
                    ...
                    <div class="activity-info">
                        ...
                        <p class="activity-details"><i class="bi bi-calendar"></i> 12 Februari 2026</p>
            ...
            <div class="col-md-3">
                <div class="card activity-card">
                    ...
                    <div class="activity-info">
                        ...
                        <p class="activity-details"><i class="bi bi-calendar"></i> 16 Maret 2026</p>
            ...
            <div class="col-md-3">
                <div class="card activity-card">
                    ...
                    <div class="activity-info">
                        ...
                        <p class="activity-details"><i class="bi bi-calendar"></i> 27 Mei 2026</p>
            ...
            <div class="col-md-3">
                <div class="card activity-card">
                    ...
                    <div class="activity-info">
                        ...
                        <p class="activity-details"><i class="bi bi-calendar"></i> 20 maret 2026</p>
    ...
    <div class="card-footer">
        <a class="btn btn-view-more" href="/pilihan">Lihat Aktivitas Lain</a>
    </div>
</div>
@if(session('success'))
