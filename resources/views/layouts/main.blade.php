...
<nav class="navbar navbar-expand-lg nav-underline nav-tabs sticky-top">
  <div class="container d-inline-flex gap-2">
    <a class="navbar-brand" href="/">TanamLagi</a>
...
<footer class="footer">
    <div class="footer-content">
        <div class="footer-branding">
            <h2><span class="brand-highlight">TanamLagi</span></h2>
            <p>Wadah digital yang menghubungkan masyarakat dalam aksi penanaman pohon dan kepedulian terhadap lingkungan.            </p>
            ...
            <p class="contact-info">
                ...
                <a href="tel:+6282211335577">+62 822 1133 5577</a>
            </p>
        </div>
